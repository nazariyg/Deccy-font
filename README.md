...
Deccy looks best with font anti-aliasing turned off. If you are using Sublime Text, you can disable text anti-aliasing by adding the following to your User Settings file:
...
On Mac, the optimal font size would be either 12 or 25, depending on the DPI of your display. On Windows, the optimal font size would be either 10 or 19.
